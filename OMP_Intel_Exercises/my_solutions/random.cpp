...
// random library is NOT thread safe
// random_last needs to beused for next calculation of random
// need to make it threadprivate so EACH thread has it's own 
// value of random_last to use for next calculation
